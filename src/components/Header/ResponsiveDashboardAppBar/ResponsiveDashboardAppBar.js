...
import BackgroundLetterAvatars from '../../../shared/BackgroundLetterAvatars';
...
function ResponsiveDashboardAppBar() {
    ...
    return (
        <AppBar className={`shadow-[0px_0px_20px_0px__rgba(0,0,0,0.65)] bg-customBluishSecondary relative px-5 ${anchorElUser ? "customAppbarSize" : ""}`}>
            <Box>
                        ...
                        user ? <Box sx={{ flexGrow: 0 }}>
                            <Tooltip title="Open settings">
                                <IconButton className='bg-white hover:bg-white' onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                                    <BackgroundLetterAvatars name={user?.name}></BackgroundLetterAvatars>
                                </IconButton>
                            </Tooltip>
                            <ProfileHeader anchorElUser={anchorElUser} isLoggedIn={isLoggedIn} handleLogout={handleLogout} handleCloseUserMenu={handleCloseUserMenu} handleUserDetails={handleUserDetails} settings={settings} notLoggedInSettings={notLoggedInSettings}></ProfileHeader>
                        </Box>
                            : ""
                    }
                </Toolbar>
...
export default ResponsiveDashboardAppBar;
